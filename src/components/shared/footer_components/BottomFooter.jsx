  ...
  return (
    <div className="flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start mt-6 space-y-5 md:space-y-0 md:space-x-8 border-t border-gray-200 pt-5">
      ...
      <div className="text-center md:text-left">
        <h2 className="text-lg md:text-xl  font-bold text-gray-300 mb-2 md:mb-4 ">
          Helpful Links
        </h2>
        <ul>
          <li>
            <a href="#" className="text-white text-semibold text-md md:text-lg">
              Our Policy
            </a>
          </li>
          <li>
      ...
      {/* Policies */}
      <div className="text-center md:text-left">
        <h2 className="text-xl  font-bold text-gray-300 mb-2 md:mb-4 ">
          Policies
        </h2>
        <ul>
          <li>
      ...
      {/* Contact Us */}
      <div className="text-center md:text-left">
        <h2 className="text-lg font-bold text-gray-300 mb-2">Contact us</h2>
        <p className="text-white text-lg">Help</p>
      </div>

      {/* Follow Us */}
      <div className="text-center md:text-left">
        <h2 className="text-lg font-bold text-gray-300 mb-2">Follow us</h2>
